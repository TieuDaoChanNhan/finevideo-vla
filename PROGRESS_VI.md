...
**Cluster:** JUPITER (JSC), partition `booster`, GPU GH200 — bảo trì phần lớn đã xong (vẫn còn 18 node lẻ tẻ ở trạng thái `maint`, không ảnh hưởng scheduling), Phase 4 FineVideo đã chuyển lại chạy SLURM bình thường (128 worker/4 GPU)  
